...
public class AuthorResourceIntTest {
    ...
    public void setup() {
        ...
        AuthorResource authorResource = new AuthorResource(authorService);
    ...
    public void createAuthorWithExistingId() throws Exception {
        ...
        AuthorDTO existingAuthorDTO = authorMapper.authorToAuthorDTO(existingAuthor);

        // An entity with an existing ID cannot be created, so this API call must fail
        restAuthorMockMvc.perform(post("/api/authors")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(existingAuthorDTO)))
